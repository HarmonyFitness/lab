...
- **Pas de bouton dans le hero** : l'action est le formulaire, juste en dessous. Un bouton qui fait défiler de deux écrans est un bouton qui ne sert à rien. Une photo, en revanche : on demande à quelqu'un de pousser la porte d'un club qu'il ne connaît pas (Hugo, 2026-09-16).
