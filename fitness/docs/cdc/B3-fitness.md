...
| Offre du moment | `/offre-du-moment` | Landing des campagnes (SMA, emailing) : reprendre la promesse de la pub et faire souscrire l'offre en cours | Adresse stable, contenu qui change (H1 et title au nom de l'offre). Hero (nom, compteur, action, et **trois preuves** : nombre de clubs, note et nombre d'avis, nombre de séances incluses par semaine, parce que devant un prix sur une page inconnue on se demande d'abord si c'est sérieux et si c'est près de chez soi ; les chiffres sont déduits des données, la note est un fait à fournir), produits de l'offre (accès en nombre de clubs, « soit env. CHF X.– par mois »), choix du club référent (même composant que Tarifs, regroupe les offres non accessibles), placé **après** le détail de l'offre : le trafic vient d'annonces payées, on tient la promesse avant de demander quoi que ce soit. La ligne « sans club » porte un lien vers le bloc du club. Une annonce géolocalisée devrait transporter son club dans l'adresse, le bloc se replie alors en ligne de rappel et les boutons sont actifs dès la première carte, bouton « Profiter de l'offre » vers Echino (lien paramétré), **Pourquoi Harmony** (quatre différenciants) et **preuve sociale** (note, nombre d'avis, témoignages) entre l'offre et l'engagement, là où le doute arrive : la landing s'adresse à des gens qui ne connaissent pas la marque, et le prix seul ne dit pas pourquoi ici plutôt qu'ailleurs. Ces deux blocs sont un ajout à valider (Hugo, 2026-09-16). Le club vient ensuite, en dernière étape, suivi de l'action : rappel du club et une ligne par offre disponible avec son prix et son bouton, parce que personne ne remonte une page pour finir ce qu'il a commencé en bas. Puis conditions, FAQ courte, lien « Voir tous nos tarifs ». Sans offre active : page conservée avec un message court et deux liens (tarifs, essai), entrée retirée du menu. **Gabarit de landing, à valider** (Hugo, 2026-09-16) : cette page est la destination d'annonces payées, donc chaque sortie du parcours est un clic acheté qui ne convertit pas. Hero avec photo pleine largeur et panneau posé dessus ; header réduit au logo et à une seule action ; pied réduit aux mentions légales et au contact ; pas de barre groupe ; pas de CTA séance d'essai, qui entrerait en concurrence avec « Profiter de l'offre ». Le logo reste cliquable, c'est la sortie de secours que tout le monde cherche. Si la variante est retenue, elle vaut pour toute landing de campagne, et il faudra décider si c'est un gabarit du CMS ou un réglage par page |
| Séance d'essai | `/seance-essai` | Générer des demandes de rappel pour un essai (pas une réservation ferme) | Accès par le bouton du header (hors menu) et les CTA essai. **Déroulé de la séance en cinq étapes** (accueil, entretien, accompagnement, autonomie, entretien de fin), placé avant le formulaire : on dit ce qu'on propose avant de demander des coordonnées, à plus forte raison quand c'est payant. Choix du club (même composant que Tarifs, libellé « Club où faire votre essai »), puis formulaire demande de rappel (date indicative J+1 à J+14, objectif repris du référentiel des cours, coordonnées, dispatch au club, qui est donc obligatoire). **L'essai est payant : « La journée d'essai Harmony est proposée au tarif de 20 CHF, déduits en cas de souscription à un abonnement avec engagement (hors abonnements mensuels sans engagement) »** (client, 2026-09-16). La condition est posée au-dessus des champs, jamais sous le bouton. Attention, elle dit « journée » alors que tout le reste du site dit « séance » : un mot à trancher, et si c'est une journée, l'adresse, le bouton du header et tous les CTA changent. Puis témoignages et réassurance |
...
- Extras : les Small Group Training et les services (linge…) ne sont inclus dans aucune formule, sauf **Premium Platinum**, qui comprend ceux vendus en ligne. Ceux vendus en club (séances de coaching en plus) ne sont compris dans aucune formule, y compris Premium Platinum : ils ne se vendent pas en ligne. **Un seul extra couvre tous les Small Group Training** : il porte le prix et les clubs, et donne accès à tous ceux du club. Les Small Group Training eux-mêmes sont des cours, sans prix propre : ni la page Tarifs ni la fiche club n'en listent le détail. L'offre de trainings varie selon les clubs (Ceremony Hyrox Max ne sera pas partout), le prix de l'extra non. Là où il s'affiche, l'extra **nomme les Small Group Training**, lus sur le planning : le visiteur voit ce qu'il achète sans qu'on en fasse des produits séparés. Sur la page Tarifs, **en deux lignes** : « Dans votre club référent » et « Dans tous les clubs de la formule [nom] ». Ce sont deux questions différentes, et c'est l'argument de l'extra sur une formule haute, depuis Meyrin, Premium ouvre sept trainings là où le club référent en propose deux. La portée de la deuxième ligne vient de la formule choisie, jamais de la catégorie du club référent ; tant qu'aucune formule n'est choisie, elle n'est pas nommée et la ligne montre le catalogue entier. Quand les deux listes sont identiques, une seule ligne. Sur une fiche club, une ligne, « Dans ce club » : la page parle d'un club, la question « et ailleurs ? » ne s'y pose pas. **Hyrox est une licence, pas un produit**, au même titre que Les Mills : Harmony l'utilise pour un cours collectif, « Les Mills Ceremony Hyrox », et pour un Small Group Training, « Ceremony Hyrox Max ». Le nom de la licence seul ne désigne rien et n'apparaît jamais comme nom de produit. Exception : les titles SEO peuvent porter le nom de la licence, parce que c'est lui que les gens cherchent. Un seul mot, « Extra », identique en club, dans l'appli, sur le site et dans Echino.
...
6. **Formules et extras du club** : les formules qui donnent accès au club (accès en nombre de clubs, « Tarif adulte dès CHF X.– / mois »), puis les extras proposés dans ce club, avec « Extra » et leur prix : l'extra « Small Group Training », qui nomme les trainings donnés dans le club sans en faire des produits, et les services. Lien « Voir les tarifs » vers `/tarifs/[slug du club]`. Partie extras masquée si le club n'a aucun extra
...
| Cours collectifs (hub) | `/sport/cours-collectifs` | Présenter les cours, montrer le planning, nourrir le SEO | Catalogue rangé par les 6 objectifs, recherche par nom, filtres (formule, club, objectif, intensité, format ; l'accès aux cours est cumulatif, filtrer Premium remonte les cours des clubs Essential et Gym), liens vers les pages de famille, jamais en section dédiée : une liste de quatre disciplines se lit comme l'inventaire de l'offre alors qu'il y en a des dizaines. La mention de famille de chaque carte du catalogue est un lien, et la famille est un cran du fil d'Ariane sur chaque fiche ; vingt-quatre cours y renvoient, contre quatre liens en section. Planning type filtrable (saisi au CMS), CTA essai, témoignages. **Le catalogue contient les Small Group Training**, marqués « Extra » : techniquement ce sont des cours collectifs, en petit groupe et payants, et les cacher privait le visiteur d'une partie de l'offre de son club. Ils ne comptent jamais dans le nombre de cours inclus d'une formule, et le compteur du hub les annonce à part (« 51 cours, dont 5 en Extra »). Un cours donné en collectif dans un club et en Extra dans un autre n'est pas marqué mais porte la mention « Inclus, sauf dans les clubs où il est donné en Extra » ; dès qu'un club ou une formule est filtré, la réponse se restreint à ce périmètre et le marqueur apparaît s'il y est payant. Le planning type marque « Extra » sur les séances concernées, sous la ligne « Inclus dans votre abonnement, sauf mention Extra » |
...
| Fiches cours (1 gabarit, ~30 pages) | `/cours/[cours]` | Page SEO par type de cours, convertir | Description + bénéfices, niveau/intensité, clubs qui le proposent + créneaux, coachs associés, CTA essai et lien vers /tarifs, FAQ intégrée. Pour un Small Group Training : mention « Extra », clubs où ce training est donné (lus sur le planning), et le prix de l'extra « Small Group Training » qui le couvre, avec la mention qu'il donne accès à tous les Small Group Training du club |
...
| Small Group Training (hub) | `/sport/small-group-training` | Présenter l'entraînement en petit groupe, payant en Extra, et capter les recherches type « hyrox genève » | Principe (un coach, quelques personnes), mention « Extra » bien visible, l'extra « Small Group Training » et son prix annoncés en haut, une fois pour tous, puis la liste des Small Group Training avec les clubs où ils sont donnés et sans prix, liens vers leurs fiches `/cours/[cours]`. « Small Group Training » est le nom de l'extra : il n'apparaît pas dans la liste comme s'il était un training, lien vers /tarifs, CTA essai. S'il n'y a qu'un Small Group Training au lancement, le hub peut attendre : sa fiche suffit |
...
| Espaces wellness | `/bien-etre/espaces` | Présenter sauna, hammam, jacuzzi, jets massants et leur répartition par club | Présentation des espaces, tableau de disponibilité par club, galerie, renvoi pages club. La répartition ne se saisit pas sur cette page : elle se déduit des équipements de chaque club, donc ajouter un sauna à un club l'inscrit au tableau sans y toucher. **Attention**, cette liste nomme quatre espaces alors que le modèle en marque cinq comme bien-être : la piscine en fait partie, et elle sert aussi aux cours aquatiques et à l'école de natation. À trancher (questions.md > Q55). La répartition sauna, hammam et jacuzzi vient du document client du 2026-09-17 ; sa ligne « Jacuzzi ou jet massant » fusionne deux équipements que le référentiel sépare et n'a pas été appliquée (questions.md > Q57) |
